...
export class KlassenFaecherService {
  zuweisungen: Array<[Fach,Lehrjahr[],number]> =  [
    [Fach.franzoesisch,[Lehrjahr.eins,
    ...
    [ Fach.handarbeit, [Lehrjahr.eins,
      Lehrjahr.zwei,Lehrjahr.drei,Lehrjahr.vier,Lehrjahr.fuenf,
      Lehrjahr.sechs,Lehrjahr.sieben,Lehrjahr.acht],2],
    [Fach.wochenabschluss,[Lehrjahr.eins,
      Lehrjahr.zwei,Lehrjahr.drei],1],
    [Fach.spielturnen,[Lehrjahr.eins,
        Lehrjahr.zwei],1],
    [Fach.sport,[Lehrjahr.drei,Lehrjahr.vier,Lehrjahr.fuenf,
      Lehrjahr.sechs,Lehrjahr.sieben,Lehrjahr.acht,Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],2],

      [Fach.religion,[Lehrjahr.eins,
        Lehrjahr.zwei,Lehrjahr.drei,Lehrjahr.vier,Lehrjahr.fuenf,
        Lehrjahr.sechs,Lehrjahr.sieben,Lehrjahr.acht],1],
   ...
   [Fach.griechisch,[Lehrjahr.fuenf],1],
    ...
    [Fach.latein,[
      ...
      [Fach.hauptunterricht,[Lehrjahr.eins,
        Lehrjahr.zwei,Lehrjahr.drei,Lehrjahr.vier,Lehrjahr.fuenf,
        Lehrjahr.sechs,Lehrjahr.sieben,Lehrjahr.acht,Lehrjahr.neun,
        Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],10],

      [Fach.schiene,[Lehrjahr.neun,
          Lehrjahr.zehn],8],
      [Fach.schiene,[Lehrjahr.elf,Lehrjahr.zwoelf],6],
  
      [Fach.rhythmisch,[Lehrjahr.neun,
        Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf],5],
   ...
   [Fach.orchester, [Lehrjahr.neun,
        Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf],2],

    [Fach.deutsch,[Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],4],
    [Fach.mathematik,[Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],4],
    [Fach.physik,[Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],1],
    ...
    [Fach.biologie, [Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],1],
    [Fach.klassenbetreuer, [Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],1],


    [Fach.schmieden, [Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],1],
    [Fach.weben, [Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],1],
    [Fach.plastizieren, [Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],1],
    [Fach.kunst, [Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],1],
 
    [Fach.chor, [Lehrjahr.neun,
      Lehrjahr.zehn,Lehrjahr.elf,Lehrjahr.zwoelf,Lehrjahr.dreizehn],1],
