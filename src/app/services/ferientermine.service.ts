...
export class FerientermineService {
 ...
 EM_muendlich: Date = new Date(2022, 5, 13);
  ...
  get pruefungsTage() {
    return [
      //Abi
       {tag: this.abiSchriftl_Deutsch, notiz: "Abi schr. Deu"},
      {tag: this.abiSchriftl_Mathematik, notiz: "Abi schr. Ma"},
      {tag: this.abiSchriftl_Englisch, notiz: "Abi schr. Eng"},
      {tag:  this.abiSchriftl_Geo, notiz: "Abi schr. Geo" },

      {tag: this.abiEnglischSprechpruefung, notiz: "Abi Sprechpr. Eng"},
      {tag:  this.abiMuendlichWoche, notiz: "Abi mündlich"},

      //ESA MSA
      {tag: this.EM_EnglischDeutsch, notiz: "EM Eng/Deu"},
      {tag:  this.EM_DeutschMathematik, notiz: "EM Deu/Ma"},
      {tag:  this.EM_MathematikEnglisch, notiz: "EM Ma/Eng"},
   
      //pfingstferien
      {tag:       this.EM_muendlich, notiz: "EM mündlich"},
      //Sommerferien
    ]
  };
  ...
  get feiertage() {
    return [
       {tag: this.feiertag_TagDerDeutschenEinheit, notiz: "Tag der deutschen Einheit"},
      //herbstferien
      {tag: this.feiertag_Reformationstag, notiz: "Reformationstag"},
      {tag: this.feiertag_weihnachtsTag1, notiz: "1. Weihnachtstag"},
      {tag:  this.feiertag_weihnachtsTag2, notiz: "2. Weihnachtstag" },
     
      //weihnachten
      //2022:
      {tag: this.feiertag_Neujahr, notiz: "Neujahr"},
      {tag:  this.feiertag_karFreitag, notiz: "Karfreitag"},

      //osterferien
      {tag: this.feiertag_ostermontag, notiz: "Ostermontag"},
      {tag:  this.feiertag_tagDerArbeit, notiz: "Tag der Arbeit"},
      {tag:  this.feiertag_christiHimmelfahrt, notiz: "Himmelfahrt"},
   
      //pfingstferien
      {tag:       this.pfingstferienStart, notiz: "Pfingstferien"},
      {tag:       this.pfingstferienEnde, notiz: "Pfingstferien"},
      {tag:       this.feiertag_pfingstMontag    , notiz: "Pfingstmontag"},
      //Sommerferien
    ]
  };
  ...
  daysBetween() {
    ...
    this.daysBetweenArray.forEach(day => {
      ...
      arr.push({        tag: day,        frei: ferien,        notiz: notiz  , wochenTag: wochenTag, unterricht: []    }); //FORMAT der TAGE
